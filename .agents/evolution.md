...
- **Release stats at session end**: 68 commits on the branch since divergence from `main`, 65 files changed, +11,529 / −817 lines. All tester-facing test cases in `testing/v1.4/test-cases.md` updated with Section M (17 subsections tracking every day-1 fix including the audit follow-ups) + M.9 critical end-to-end walkthrough with post-audit extra-verify items.
