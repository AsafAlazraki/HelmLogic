...
| v1.7 Customer-PDF authoring (Content Blocks + Live Preview + Image authoring + per-Salesperson) | ✅ Shipped to dev. See `tasks/RELEASE_NOTES_v1.7.0.md`. Pending dev → main PR. |
