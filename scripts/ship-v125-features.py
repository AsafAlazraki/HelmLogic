#!/usr/bin/env python3
"""Flip v1.25 stories to status='shipped' in Firestore. Idempotent.
Built + browser-tested on dev. Run after the v1.25 work lands on dev."""
import requests, sys
PROJECT="studio-2290360004-3b963"; API_KEY="AIzaSyDJ7b5G9zL2uTpDzgwTLvQtVUIyaVBpSBY"
SHIP_PREFIXES=('1.1.4 ','1.4.5 ','1.6.1 ','2.4.6 ')
...
for row in rows:
    ...
    if f.get("targetRelease")!="v1.25": continue
