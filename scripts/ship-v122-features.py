#!/usr/bin/env python3
"""Flip v1.22 stories to status='shipped' in Firestore. Idempotent.
Built + browser-tested on dev. Run after the v1.22 work lands on dev."""
import requests, sys
PROJECT="studio-2290360004-3b963"; API_KEY="AIzaSyDJ7b5G9zL2uTpDzgwTLvQtVUIyaVBpSBY"
SHIP_PREFIXES=('1.7.3 ','1.8.3 ','2.6.1 ','2.7.1 ','4.1.1 ','8.1.1 ','8.1.5 ')
...
for row in rows:
    ...
    if f.get("targetRelease")!="v1.22": continue
