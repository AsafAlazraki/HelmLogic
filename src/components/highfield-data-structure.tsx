...
import { Loader2, PlusCircle, Trash2, Sailboat, Pencil, X, ArrowUp, ArrowDown, ChevronDown } from 'lucide-react';
...
export function HighfieldDataStructure({ vendorId, vendorSlugOrId }: { vendorId: string, vendorSlugOrId: string }) {
    ...
    const handleSeedData = async () => {
        ...
        try {
            ...
            await batch.commit();
            toast({ title: 'Success', description: 'Initial Highfield data has been created.' });
        } catch (error) {
                ...
                <Card>
                    <CardHeader>
                         <div className="flex items-center justify-between">
                            <div>
                                <CardTitle>Highfield Product Ranges</CardTitle>
