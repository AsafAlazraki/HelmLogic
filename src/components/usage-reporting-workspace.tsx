...
import { Loader2, Download, MousePointerClick, Users, Timer, Activity } from 'lucide-react';
                ...
                <>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
                        {[
                            ...
                            { icon: MousePointerClick, label: 'Actions captured', value: kpis.actions.toLocaleString() },
                    ...
                    <Card className="rounded-2xl border-2">
                        <CardHeader>
                            <CardTitle className="text-xs font-black uppercase tracking-widest">
                                Event explorer <span className="text-slate-400 normal-case font-bold">— every click, page view and action ({fEvents.length.toLocaleString()} in view)</span>
                            </CardTitle>
                        </CardHeader>
                        <CardContent>
