...
const initialRanges = ['Workmate', 'Workmate Hardtop', 'Game Fisher', 'Pro Fisher'];

export function SurteesDataStructure({ vendorId, vendorSlugOrId }: { vendorId: string, vendorSlugOrId: string }) {
    ...
    const handleSeedData = async () => {
        ...
        try {
            ...
            await batch.commit();
            toast({ title: 'Success', description: 'Initial Surtees data has been created.' });
        } catch (error) {
                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center justify-between">
                            <div>
                                <CardTitle>Surtees Product Ranges</CardTitle>
                                <CardDescription>Manage product ranges and models for Surtees boats.</CardDescription>
                            </div>
                    ...
                    <CardContent className="pt-6">
                        {ranges && ranges.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center h-48 border-2 border-dashed rounded-lg">
                                <p className="text-muted-foreground">No data structure found for Surtees.</p>
