...
const EPICS: SeedEpic[] = [
    { id: 'guided-configuration',   title: 'Guided Configuration & Quote Creation',     shortLabel: 'Guided Config', description: 'Validated configuration flow + branded customer-ready proposal output. The SCIBS demo win — emotional + technically accurate.',                                              color: 'blue',    order: 100, status: 'active'   },
